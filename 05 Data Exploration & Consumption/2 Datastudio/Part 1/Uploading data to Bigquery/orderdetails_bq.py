...
table_id = "ssbc-99.mydukan.order_details"
job_config = bigquery.LoadJobConfig(
    ...
    schema = [
            ...
            bigquery.SchemaField("orderplaceddatetime", "TIMESTAMP"),
            bigquery.SchemaField("ordercompletiondatetime", "TIMESTAMP"),
            bigquery.SchemaField("orderstatus", "STRING"),
            ]
    )
uri = "gs://msn-datastudio/order_details" 
